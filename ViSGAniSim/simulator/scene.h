...
public:
	...
	void UpdateBodyData(Obj &body, Obj &pre_body);
    vector<Obj> body;
...
private:
	...
	static void RenderGPU_CUDA(vector<Obj> &body);
...
private:
	glm::vec4* body_p_vertex;           //指向OPENGL buffer中vertex的地址
	glm::vec3* body_p_normal;           //指向OPENGL buffer中normal的地址
